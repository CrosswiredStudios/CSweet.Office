...
rm -f -- /Library/LaunchDaemons/com.csweet.satelliteoffice.node.plist
rm -f -- /Library/LaunchDaemons/com.csweet.satelliteoffice.runtime.plist
rm -rf -- /Library/Application\ Support/CSweet/Execution
rm -rf -- /Library/Application\ Support/CSweet/SatelliteOffice
...
rm -f -- /usr/local/sbin/csweet-configure-satellite-office
rm -f -- /usr/local/sbin/csweet-uninstall-satellite-office
pkgutil --forget com.csweet.satellite-office.payload >/dev/null 2>&1 || true
