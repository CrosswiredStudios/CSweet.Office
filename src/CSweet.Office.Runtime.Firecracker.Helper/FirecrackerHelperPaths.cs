    ...
    string ParentCgroup)
{
    ...
    {
        var dataRoot = AbsoluteEnvironment("CSWEET_FIRECRACKER_DATA_ROOT", "/var/lib/csweet/office/firecracker");
        var packageRoot = AbsoluteEnvironment("CSWEET_FIRECRACKER_PACKAGE_ROOT", "/opt/csweet/office/firecracker");
