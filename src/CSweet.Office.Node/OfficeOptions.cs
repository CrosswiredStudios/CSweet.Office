...
public sealed class OfficeOptions
{
    ...
    public Guid? AssistedSetupSessionId { get; set; }
    ...
    public string OfficeName { get; set; } = Environment.MachineName;
    ...
    public OfficeSecurityPostureReport SecurityPosture()
    {
        ...
        return new OfficeSecurityPostureReport(
