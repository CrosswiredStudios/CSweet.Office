...
using CSweet.SatelliteOffice.Runtime.Artifacts;
using CSweet.SatelliteOffice.Runtime.Protocol;
using Grpc.Core;

namespace CSweet.SatelliteOffice.Node;

public sealed class SatelliteOfficeArtifactCache : IAgentArtifactStore
{
    private readonly string _root;
    private readonly IAgentArtifactMediaStore _media;

    public SatelliteOfficeArtifactCache(SatelliteOfficeOptions options)
    {
    ...
    public Task<AgentArtifactReference> ImportAsync(
        ...
        throw new NotSupportedException("Satellite Offices receive artifacts only through assignment-scoped grants.");
